	...
	return (
		<div className={cn('relative h-full w-full p-1', className)}>
			...
			<div
				...
				style={{
					backgroundColor,
					maskImage: `radial-gradient(circle at 50% 50%, transparent 2px, black 2px)`,
					maskSize: `${8 * density}px ${8 * density}px`,
					WebkitMaskImage: `radial-gradient(circle at 50% 50%, transparent 2px, black 2px)`,
					WebkitMaskSize: `${8 * density}px ${8 * density}px`,
					transition: 'background-color 0.4s ease',
				}}
			/>
		</div>
