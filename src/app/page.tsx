      ...
      <PaintZone>
        <section id="about" className="hero">
          ...
          <p className="hero-bio">
            ...
            , building idps™ — an ai-powered positioning stack that keeps navigation accurate without
            gps. interested in software engineering, data science, full-stack development, and mobile
            engineering.
          </p>
